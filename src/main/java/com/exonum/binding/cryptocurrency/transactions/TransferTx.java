...
public final class TransferTx implements Transaction {
  ...
  private static final Serializer<ServiceProtos.TransferTx> PROTO_SERIALIZER =
      protobuf(ServiceProtos.TransferTx.class);
  ...
  static TransferTx from(byte[] arguments) {
    ServiceProtos.TransferTx body = PROTO_SERIALIZER.fromBytes(arguments);
